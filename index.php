...
<head>
	...
	<title><?php echo SISTEMA ?> | Login</title>
									...
									<form role="form" class="text-start" method="POST" action="autenticar.php">
									  ...
									  <!-- Quando o formulário é enviado pelo método POST o arquivo de autenticação (autenticar.php) é executado -->
										...
										<div class="input-group input-group-outline my-3">
											...
											<input type="text" class="form-control text-uppercase" name="usuario" required>
										</div>

										<div class="input-group input-group-outline mb-3 left-inner-addon">
											<label class="form-label">Senha</label>
											<i id="showPassword" class="fa fa-eye" onclick="mostrar(this)"></i>
											<input type="password" class="form-control" name="senha" required>
										</div>

										<div class="text-center">
											<button type="submit" class="btn bg-gradient-primary-login w-100 my-4 mb-2 text-white">Entrar</button>

											<p class="mt-3 small">Esqueceu sua senha? <a href="recuperar.php">Clique aqui.</a></p>
